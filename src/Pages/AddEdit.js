...
const AddEdit = () => {
  ...
  const { key } = useParams();
  useEffect(() => {
    dataRef.ref("Allsections").on("value", (snapshot) => {
  ...
  //         if (fetchedData !== null && fetchedData[key] !== undefined) {
  //           setItemlist({ ...fetchedData[key] });
  //         } else {
  //           setItemlist({});
  //         }
  //       })
              ...
              <div className="">
                ...
                <div className="mx-auto  w-[97%]  border-2 h-36 rounded-xl">
                  <div className="flex items-center w-full  mt-10 pl-10">
                    <p className="text-2xl   font-semibold"> gmail.com</p>
                    <button className="text-2xl   flex justify-end   w-full pr-20 font-semibold">
                      <RxCross1 />
                    </button>
                  </div>
                  <button
              ...
              <div className="p-3">
                ...
                <div className=" mb-2" data-te-input-wrapper-init>
                  <textarea
                    ...
                    value={section3messege.section3messege || ""}
                  >
                    {" "}
                  </textarea>
                </div>
